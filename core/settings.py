...
SECRET_KEY = 'django-insecure-y+8*x#e7(s5u_7-9w+bi4sv)vyi)jf@sww@m_bqs^70#$uwrdn'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Django'nun çalışmasına izin verilen güvenli alan adları
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'h1papc1.onrender.com', '.onrender.com']


# Application definition

# core/settings.py içindeki ilgili bölüm
...
# Medya dosyalarının (Kullanıcı yüklemeleri) URL uzantısı
MEDIA_URL = '/media/'

# Medya dosyalarının bilgisayarda (sunucuda) fiziksel olarak kaydedileceği klasör
...
# GÜVENLİK AYARLARI (HTTPS ZORUNLULUĞU)
# Not: Localhost'ta test ederken geçici olarak bu satırları yorum satırı (#) yapabilirsin.
